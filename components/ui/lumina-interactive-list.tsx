...
export function Component() {
  ...
  useEffect(() => {
    ...
    const initApplication = async () => {
        ...
        const slides = [
            { title: "Ethereal Glow", description: "A soft, radiant light that illuminates the soul.", media: "https://cdn.21st.dev/assets/mirror/b2/b26ed9367c41626c7e61d837f0ea11cdaa3148a499e6bee171176886c8959950.jpg" },
            { title: "Rose Mirage", description: "Lost in a desert of blooming dreams and endless horizons.", media: "https://cdn.21st.dev/assets/mirror/40/4028a63d1229ffb5d2eccc4c4f7640858afb1bbf639fc41b9a86a376a1202555.jpg" },
            { title: "Velvet Mystique", description: "Wrapped in the deep, luxurious embrace of the night.", media: "https://cdn.21st.dev/assets/mirror/e6/e65a4e822aa4606715518071f6d85d2066b721b8e7e952e8ab6c051e87bc7a36.jpg" },
            { title: "Golden Hour", description: "That fleeting moment when the world is dipped in gold.", media: "https://cdn.21st.dev/assets/mirror/87/87882922b01fff1934486f69e7ee39a5a5e05bf2b935bb03a916234be898ee0e.jpg" },
            { title: "Midnight Dreams", description: "Where reality fades and imagination takes flight.", media: "https://cdn.21st.dev/assets/mirror/99/99ee55fd55281f879bd8cf899e4cb967a99a142d6b571765e46a88ad619ee9de.jpg" },
            { title: "Silver Light", description: "A cool, metallic shimmer reflecting the urban pulse.", media: "https://cdn.21st.dev/assets/mirror/24/24ae667023524d2b6621597f09bf7062c9eadf03fe98d0f2c741637ede1131fc.jpg" }
        ];
        ...
        const onResize = () => { if (renderer && shaderMaterial) { renderer.setSize(window.innerWidth, window.innerHeight); shaderMaterial.uniforms.uResolution.value.set(window.innerWidth, window.innerHeight); } };
