 ...
 * Foolproof: Automatically validates MIME types, strips prefixes, auto-ensures bucket, and retries on transient blips.
...
export async function uploadScreenshotToStorage(base64Data, filenamePrefix = 'delegate', format = 'webp') {
  ...
  try {
    ...
    // Clean prefix and detect format
    ...
    // Upload with 1 retry on network blip
